...
COPY public."build/company" (id, name, kind, glyph) FROM stdin;
11	RiscFree	CPU	∺
7	SilPath	BRD	≶
3	TransGlobal	ANT	∅
13	Evoke	DSK	⋙
...
17	Never Dare To Ask	Common	5	1	Analyze	1	0	99	TARG:AA|LOOP:01	CRED	Local
\.
...
COPY public."detail/general" (id, name, kind, glyph) FROM stdin;
...
COPY public."detail/specific" (id, name, general, glyph) FROM stdin;
57	Accounting	15	💰
33	Campus	9	🚍
40	Municipal	10	🏛
32	OpenSource	8	🐧
...
SELECT pg_catalog.setval('public.card_id_seq', 17, true);
...
--
-- Name: card card_pk; Type: CONSTRAINT; Schema: public; Owner: smithy
--

ALTER TABLE ONLY public.card
    ADD CONSTRAINT card_pk PRIMARY KEY (rarity, id, set);
