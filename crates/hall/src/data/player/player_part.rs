...
type AttributeArray = [attribute::AttributeValueType; 4];
...
mod test {
    ...
    fn test_player_part() {
        ...
        let orig = PlayerPart {
            ...
            values: [9, 1, 9, 1],
            build: [
                PlayerBuild { number: 1, build: Build::ANT(4, 1), value: 9 },
                PlayerBuild { number: 2, build: Build::BRD(3, 2), value: 8 },
                PlayerBuild { number: 3, build: Build::CPU(2, 3), value: 7 },
                PlayerBuild { number: 4, build: Build::DSK(1, 4), value: 6 },
            ],
            detail: [
                PlayerDetail { number: 1, detail: Detail::Institution(4, 1), value: 5 },
                PlayerDetail { number: 2, detail: Detail::Role(3, 2), value: 4 },
                PlayerDetail { number: 3, detail: Detail::Location(2, 3), value: 3 },
                PlayerDetail { number: 4, detail: Detail::Distro(1, 4), value: 2 },
            ],
        };
        buf.push(&orig);
